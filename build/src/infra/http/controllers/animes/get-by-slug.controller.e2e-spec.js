...
(0, vitest_1.describe)('Create Anime (e2e)', () => {
    ...
    (0, vitest_1.it)('[GET] /animes/[:slug]', async () => {
        ...
        const response = await (0, supertest_1.default)(app_1.app.server).get('/animes/jujutsu');
        (0, vitest_1.expect)(response.statusCode).toEqual(200);
        (0, vitest_1.expect)(response.body.anime.title).toBe('Jujutsu');
    });
});
