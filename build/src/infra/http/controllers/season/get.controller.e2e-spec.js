...
(0, vitest_1.describe)('Get Season (e2e)', () => {
    ...
    (0, vitest_1.it)('[GET] /seasons/[:id]', async () => {
        ...
        const response = await (0, supertest_1.default)(app_1.app.server).get(`/seasons/${seasonPrisma.id}`);
        (0, vitest_1.expect)(response.statusCode).toEqual(200);
        (0, vitest_1.expect)(response.body.season.title).toBe('Temporada 01');
        (0, vitest_1.expect)(response.body.season.episodes[0].title).toBe('Episode 01');
    });
});
